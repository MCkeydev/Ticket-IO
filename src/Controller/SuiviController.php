...
class SuiviController extends AbstractController
{
    ...
    public function index(Ticket $ticket): Response {
        ...
        $isAllowed = $this->isGranted('ROLE_OPERATEUR') || $currentUser->getService() === $ticket->getService();
         ...
         */
        $objects = array_merge($commentaires->toArray(), $taches->toArray(), $solutions->toArray());
