...
class CommentaireController extends AbstractController
{
    ...
    #[Route('/commentaire/create/{id}', name: 'app_commentaire_create', methods: ['get','post'])]
    public function createCommentaire(Ticket $ticket, EntityManagerInterface $manager, Request $request): Response
    {
